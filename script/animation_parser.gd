...
var trans_ref = {
	...
	"RightToes": ["XZY", [1, 1, -1]],
#	手部
	"RightMiddleProximal": ["YZX", [-1, 1, 1]],
	"LeftMiddleProximal": ["YZX", [-1, 1, 1]],
	"LeftThumbMetacarpal": ["YZX", [-1, 1, 1]],
  "LeftThumbProximal": ["YZX", [-1, 1, 1]],
 "LeftThumbDistal": ["YZX", [-1, 1, 1]],
   "LeftIndexProximal": ["YZX", [-1, 1, 1]],
 "LeftIndexIntermediate":["YZX", [-1, 1, 1]],
  "LeftIndexDistal":["YZX", [-1, 1, 1]],
  "LeftMiddleIntermediate": ["YZX", [-1, 1, 1]],
  "LeftMiddleDistal":["YZX", [-1, 1, 1]],
 "LeftRingProximal": ["YZX", [-1, 1, 1]],
 "LeftRingIntermediate":["YZX", [-1, 1, 1]],
  "LeftRingDistal":["YZX", [-1, 1, 1]],
  "LeftLittleProximal": ["YZX", [-1, 1, 1]],
  "LeftLittleIntermediate": ["YZX", [-1, 1, 1]],
  "LeftLittleDistal": ["YZX", [-1, 1, 1]],
  "RightThumbMetacarpal": ["YZX", [1, -1, -1]],
  "RightThumbProximal": ["YZX", [1, -1, -1]],
  "RightThumbDistal": ["YZX", [1, -1, -1]],
  "RightIndexProximal": ["YZX", [1, -1, -1]],
  "RightIndexIntermediate": ["YZX", [1, -1, -1]],
  "RightIndexDistal": ["YZX", [1, -1, -1]],
  "RightMiddleIntermediate": ["YZX", [1, -1, -1]],
  "RightMiddleDistal": ["YZX", [1, -1, -1]],
  "RightRingProximal": ["YZX", [1, -1, -1]],
  "RightRingIntermediate": ["YZX", [1, -1, -1]],
 "RightRingDistal": ["YZX", [1, -1, -1]],
  "RightLittleProximal": ["YZX", [1, -1, -1]],
  "RightLittleIntermediate": ["YZX", [1, -1, -1]],
  "RightLittleDistal": ["YZX", [1, -1, -1]],
}
# 轴顺序枚举
...
func get_test_angle(raw_rotation:Vector3,trans:Transform3D,bone_name:String):
...
#				以下是解析丑陋的实现，线性代数不太好
				if bone_id > 0:
					...
					var human_id=human.find_bone(remapped_bone_names[bone_index])
					var trans: Transform3D = human.get_reference_pose(human_id)
					var localTrans = root_transform * trans
					if step==0:
						#var human= SkeletonProfileHumanoid.new()
						#var human_id=human.find_bone(remapped_bone_names[bone_index])
						#print("find bone:",remapped_bone_names[bone_index],human.get_reference_pose(human_id).basis.get_euler(),trans.basis.get_euler())
						#get_test_angle(raw_rotation,trans,remapped_bone_names[bone_index])
						pass
